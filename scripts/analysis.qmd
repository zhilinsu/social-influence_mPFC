...
# Preparation 
lesion_kld_diff_mpfc <- read.csv("data/norm_kl_diff_pos_tfce_mpfc.csv",
																 header = TRUE) |>
	as_tibble() |>
...
# Preparation 
lesion_self1_km_mpfc <- read.csv("data/self_1_km_pos_tfce_mpfc.csv",
																 header = TRUE) |>
	as_tibble() |> 
	mutate(id = as.double(id), 
...
# Preparation 
lesion_kld_diff_all <- read.csv("data/norm_kl_diff_pos_tfce_all.csv",
																header = TRUE) |> 
	as_tibble() |>
	mutate(id = as.double(id), 
				 norm_kl_diff_pos_voxels = as.double(norm_kl_diff_pos_voxels), 
...
# Preparation 
lesion_self1_km_all <- read.csv("data/self_1_km_pos_tfce_all.csv",
																header = TRUE) |>
	as_tibble() |> 
	mutate(id = as.double(id), 
				 self_1_km_pos_voxels = as.double(self_1_km_pos_voxels), 
