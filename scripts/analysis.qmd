...
set.seed(1213)
rho_samples <- spearmanGibbsSampler(xVals = data_acc_kld_hc_i$acc,
																		yVals = data_acc_kld_hc_i$norm_kl)
...
set.seed(1213)
rho_samples <- spearmanGibbsSampler(xVals = data_acc_kld_hc_p$acc,
																		yVals = data_acc_kld_hc_p$norm_kl)
...
set.seed(1213)
rho_samples <- spearmanGibbsSampler(xVals = data_acc_kld_mpfc_i$acc,
																		yVals = data_acc_kld_mpfc_i$norm_kl)
